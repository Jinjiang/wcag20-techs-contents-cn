...
* SMIL 技巧 [(单页展示所有 SMTL 技巧)](https://www.w3.org/TR/WCAG20-TECHS/smil.html)
    * [SM1：在 SMIL 1.0 中增加音频扩展描述](https://www.w3.org/TR/WCAG20-TECHS/SM1.html)
    * [SM2：在 SMIL 2.0 中增加音频扩展描述](https://www.w3.org/TR/WCAG20-TECHS/SM2.html)
    * [SM6：在 SMIL 1.0 中提供音频描述](https://www.w3.org/TR/WCAG20-TECHS/SM6.html)
    * [SM7：在 SMIL 2.0 中提供音频描述](https://www.w3.org/TR/WCAG20-TECHS/SM7.html)
    * [SM11：在 SMIL 1.0 中通过同步的文字流提供字幕](https://www.w3.org/TR/WCAG20-TECHS/SM11.html)
    * [SM12：在 SMIL 2.0 中通过同步的文字流提供字幕](https://www.w3.org/TR/WCAG20-TECHS/SM12.html)
    * [SM13：在 SMIL 1.0 中通过同步的视频流提供手语翻译](https://www.w3.org/TR/WCAG20-TECHS/SM13.html)
    * [SM14：在 SMIL 2.0 中通过同步的视频流提供手语翻译](https://www.w3.org/TR/WCAG20-TECHS/SM14.html)
* 文本技巧 [(单页展示所有文本技巧)](https://www.w3.org/TR/WCAG20-TECHS/text.html)
    * [T1：为段落使用标准的文本格式约定](https://www.w3.org/TR/WCAG20-TECHS/T1.html)
    * [T2：为列表使用标准的文本格式约定](https://www.w3.org/TR/WCAG20-TECHS/T2.html)
    * [T3：为段落标题使用标准的文本格式约定](https://www.w3.org/TR/WCAG20-TECHS/T3.html)
* ARIA 技巧 [(单页展示所有 ARIA 技巧)](https://www.w3.org/TR/WCAG20-TECHS/aria.html)
    * [WAI-ARIA 技术备忘](https://www.w3.org/TR/WCAG20-TECHS/wai-aria_notes.html)
    * [ARIA1：使用 `aria-describedby` 属性为用户界面控件提供描述性标签](https://www.w3.org/TR/WCAG20-TECHS/ARIA1.html)
    * [ARIA2：使用 `aria-required` 属性标识必填字段](https://www.w3.org/TR/WCAG20-TECHS/ARIA2.html)
    * [ARIA4：使用 WAI-ARIA `role` 来暴露用户界面组件的角色](https://www.w3.org/TR/WCAG20-TECHS/ARIA4.html)
    * [ARIA5：使用 WAI-ARIA 状态特性和属性特性来暴露用户界面组件的状态](https://www.w3.org/TR/WCAG20-TECHS/ARIA5.html)
    * [ARIA6：使用 `aria-label` 为对象提供标签](https://www.w3.org/TR/WCAG20-TECHS/ARIA6.html)
    * [ARIA7：使用 `aria-labelledby` 建立链接](https://www.w3.org/TR/WCAG20-TECHS/ARIA7.html)
    * [ARIA8：使用 `aria-label` 建立链接](https://www.w3.org/TR/WCAG20-TECHS/ARIA8.html)
    * [ARIA9：使用 `aria-labelledby` 连接多个文本节点的标签](https://www.w3.org/TR/WCAG20-TECHS/ARIA9.html)
    * [ARIA10：使用 `aria-labelledby` 为非文本内容提供文本替代品](https://www.w3.org/TR/WCAG20-TECHS/ARIA10.html)
    * [ARIA11：使用 ARIA 地标来识别页面的区域](https://www.w3.org/TR/WCAG20-TECHS/ARIA11.html)
    * [ARIA12：使用 `role=heading` 来标识标题](https://www.w3.org/TR/WCAG20-TECHS/ARIA12.html)
    * [ARIA13：使用 `aria-labelledby` 来命名区域和地标](https://www.w3.org/TR/WCAG20-TECHS/ARIA13.html)
    * [ARIA14：在可见标签无法使用的地方使用 `aria-label` 提供不可见标签](https://www.w3.org/TR/WCAG20-TECHS/ARIA14.html)
    * [ARIA15：使用 `aria-describedby` 来描述图像](https://www.w3.org/TR/WCAG20-TECHS/ARIA15.html)
    * [ARIA16：使用 `aria-labelledby` 为用户界面控件提供名称](https://www.w3.org/TR/WCAG20-TECHS/ARIA16.html)
    * [ARIA17：通过将角色分组来标识相关联的表单控件](https://www.w3.org/TR/WCAG20-TECHS/ARIA17.html)
    * [ARIA18：使用 `aria-alertdialog` 来识别错误](https://www.w3.org/TR/WCAG20-TECHS/ARIA18.html)
    * [ARIA19：使用 ARIA `role=alert` 或实时区域来识别错误](https://www.w3.org/TR/WCAG20-TECHS/ARIA19.html)
    * [ARIA20：使用区域角色来标识页面的一个区域](https://www.w3.org/TR/WCAG20-TECHS/ARIA20.html)
    * [ARIA21：使用 `aria-invalid` 标识错误字段](https://www.w3.org/TR/WCAG20-TECHS/ARIA21.html)
* Flash 技巧 [(单页展示所有 Flash 技巧)](https://www.w3.org/TR/WCAG20-TECHS/flash.html) (未展开翻译子目录)
* Silverlight 技巧 [(单页展示所有 Silverlight 技巧)](https://www.w3.org/TR/WCAG20-TECHS/silverlight.html) (未展开翻译子目录)
* PDF 技巧 [(单页展示所有 PDF 技巧)](https://www.w3.org/TR/WCAG20-TECHS/pdf.html) (未展开翻译子目录)
* 常见失败原因 [(单页展示所有常见失败原因)](https://www.w3.org/TR/WCAG20-TECHS/failures.html)
    * [F1: 成功标准 1.3.2 由于将信息通过 CSS 定位来改变内容的意义而失败](https://www.w3.org/TR/WCAG20-TECHS/F1.html)
    * [F2: 成功标准 1.3.1 由于通过文本显示的变化来传达信息但没有使用适当的标记或文字而失败](https://www.w3.org/TR/WCAG20-TECHS/F2.html)
    * [F3: 成功标准 1.1.1 由于通过 CSS 包含图像以传达重要信息而失败](https://www.w3.org/TR/WCAG20-TECHS/F3.html)
    * [F4: 成功标准 2.2.2 由于使用 `text-decoration:blink` 但没有机制使其不到五秒钟内停止而失败](https://www.w3.org/TR/WCAG20-TECHS/F4.html)
    * [F7: 成功标准 2.2.2 由于 Java 或 Flash 之类的 object 或 applet 具有闪烁的内容但没有机制使其暂停闪烁超过五秒而失败](https://www.w3.org/TR/WCAG20-TECHS/F7.html)
    * [F8: 成功标准 1.2.2 由于字幕省略了一些对话或重要的音效而失败](https://www.w3.org/TR/WCAG20-TECHS/F8.html)
    * [F9: 成功标准 3.2.5 由于用户从表单元素中移除焦点时改变了上下文而失败](https://www.w3.org/TR/WCAG20-TECHS/F9.html)
    * [F10: 成功标准 2.1.2 和一致性要求 5，由于结合多种内容格式使得用户在某种格式中受困而失败](https://www.w3.org/TR/WCAG20-TECHS/F10.html)
    * [F12: 成功标准 2.2.5 由于会话时间有限制，但没有机制来保存用户的输入，导致在重新认证后信息需要重建而失败](https://www.w3.org/TR/WCAG20-TECHS/F12.html)
    * [F13: 成功标准 1.1.1 和 1.4.1 由于文本替代品不包含原图像中通过色彩差异传递的信息而失败](https://www.w3.org/TR/WCAG20-TECHS/F13.html)
    * [F14: 成功标准 1.3.3 由于仅通过其形状或位置识别内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F14.html)
    * [F15: 成功标准 4.1.2 由于实现的自定义控件没有使用或没有完全使用可访问性 API 技术而失败](https://www.w3.org/TR/WCAG20-TECHS/F15.html)
    * [F16: 成功标准 2.2.2 由于包括滚动内容，但从使用的角度是无法移动的，同时没有包括暂停和重新启动内容的机制而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F16.html)
    * [F19: 一致性要求 1 由于没有提供一种方法让用户为不符合标准的网页找到替代品的版本而失败](https://www.w3.org/TR/WCAG20-TECHS/F19.html)
    * [F20: 成功标准 1.1.1 和 4.1.2 由于在非文本内容改变时不更新文本替代品而失败](https://www.w3.org/TR/WCAG20-TECHS/F20.html)
    * [F22: 成功标准 3.2.5 由于打开了用户未要求过的窗口而失败](https://www.w3.org/TR/WCAG20-TECHS/F22.html)
    * [F23: 成功标准 1.4.2 由于播放超过 3 秒的声音而无法将其关闭而失败](https://www.w3.org/TR/WCAG20-TECHS/F23.html)
    * [F24: 成功标准 1.4.3、1.4.6 和 1.4.8 由于指定前景颜色而不指定背景颜色，或反之行事，而失败](https://www.w3.org/TR/WCAG20-TECHS/F24.html)
    * [F25: 成功标准 2.4.2 由于网页标题没有标识其内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F25.html)
    * [F26: 成功标准 1.3.3 由于仅通过图形符号来传达信息而失败](https://www.w3.org/TR/WCAG20-TECHS/F26.html)
    * [F30: 成功标准 1.1.1 和 1.2.1 由于使用没有替代作用的文本替代品 (例如文件名或占位符文本) 而失败](https://www.w3.org/TR/WCAG20-TECHS/F30.html)
    * [F31: 成功标准 3.2.4 由于在一组网页中为每个网页相同的功能使用不同的标签而失败](https://www.w3.org/TR/WCAG20-TECHS/F31.html)
    * [F32: 成功标准 1.3.2 由于使用空字符来控制单词内的字符间距而失败](https://www.w3.org/TR/WCAG20-TECHS/F32.html)
    * [F33: 成功标准 1.3.1 和 1.3.2 由于使用空字符创建多列纯文本内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F33.html)
    * [F34: 成功标准 1.3.1 和 1.3.2 由于使用空字符来格式化表格的纯文本内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F34.html)
    * [F36: 成功标准 3.2.2 由于当表单中的最后一个字段被赋值时，无需事先警告就自动提交表单并呈现新内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F36.html)
    * [F37: 成功标准 3.2.2 由于在改变单选框、复选框或选择列表的选中状态时无需预先警告就启动新窗口而失败](https://www.w3.org/TR/WCAG20-TECHS/F37.html)
    * [F38: 成功标准 1.1.1 由于 HTML 中的装饰图像没有标记为被辅助技术忽略的内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F38.html)
    * [F39: 成功标准 1.1.1 由于为应被辅助技术忽略的图像提供非空的文本替代品 (例如 `alt="spacer"` 或 `alt="image"`) 而失败](https://www.w3.org/TR/WCAG20-TECHS/F39.html)
    * [F40: 成功标准 2.2.1 和 2.2.4 由于使用有时间限制的 `meta` 重定向而失败](https://www.w3.org/TR/WCAG20-TECHS/F40.html)
    * [F41: 成功标准 2.2.1、2.2.4 和 3.2.5 由于使用 `meta` 刷新重新载入页面而失败](https://www.w3.org/TR/WCAG20-TECHS/F41.html)
    * [F42: 成功标准 1.3.1、2.1.1、2.1.3 或 4.1.2 由于模拟链接而失败](https://www.w3.org/TR/WCAG20-TECHS/F42.html)
    * [F43: 成功标准 1.3.1 由于使用结构标记的方式没有表示出内容中的关系而失败](https://www.w3.org/TR/WCAG20-TECHS/F43.html)
    * [F44: 成功标准 2.4.3 由于通过 `tabindex` 创建了缺乏意义和可操作性的标签顺序而失败](https://www.w3.org/TR/WCAG20-TECHS/F44.html)
    * [F46: 成功标准 1.3.1 由于在布局表格中使用 `th` 元素，`caption` 元素或非空 `summary` 特性而失败](https://www.w3.org/TR/WCAG20-TECHS/F46.html)
    * [F47: 成功标准 2.2.2 由于使用闪烁元素而失败](https://www.w3.org/TR/WCAG20-TECHS/F47.html)
    * [F48: 成功标准 1.3.1 由于使用 `pre` 元素来标记表格式信息而失败](https://www.w3.org/TR/WCAG20-TECHS/F48.html)
    * [F49: 成功标准 1.3.2 由于使用了在线性化后失去意义的 HTML 布局表格而失败](https://www.w3.org/TR/WCAG20-TECHS/F49.html)
    * [F50: 成功标准 2.2.2 由于使用脚本展示闪烁效果但没有机制在 5 秒内将闪烁停止而失败](https://www.w3.org/TR/WCAG20-TECHS/F50.html)
    * [F52: 成功标准 3.2.1 和 3.2.5 由于新页面加载后打开新窗口而失败](https://www.w3.org/TR/WCAG20-TECHS/F52.html)
    * [F54: 成功标准 2.1.1 由于某功能仅限指定设备的事件处理程序 (包括手势) 而失败](https://www.w3.org/TR/WCAG20-TECHS/F54.html)
    * [F55: 成功标准 2.1.1、2.4.7 和 3.2.1 由于使用脚本使得焦点在收到时就被移除而失败](https://www.w3.org/TR/WCAG20-TECHS/F55.html)
    * [F58: 成功标准 2.2.1 由于使用服务器端技术将页面在超时后自动重定向而失败](https://www.w3.org/TR/WCAG20-TECHS/F58.html)
    * [F59: 成功标准 4.1.2 由于在 HTML 中使用脚本将 `div` 或 `span` 作为用户界面控件，但不提供控件的 `role` 而失败](https://www.w3.org/TR/WCAG20-TECHS/F59.html)
    * [F60: 成功标准 3.2.5 由于用户将文本输入到 `input` 字段时启动新窗口而失败](https://www.w3.org/TR/WCAG20-TECHS/F60.html)
    * [F61: 成功标准 3.2.5 由于通过自动更新完成主要内容的更改但用户无法将其禁用而失败](https://www.w3.org/TR/WCAG20-TECHS/F61.html)
    * [F63: 成功标准 2.4.4 由于链接的上下文并不在链接所在的内容中而失败](https://www.w3.org/TR/WCAG20-TECHS/F63.html)
    * [F65: 成功标准 1.1.1 由于省略了 `img` 元素、`area` 元素和 `"image"` 类型输入元素的 `alt` 属性或文本替代品而失败](https://www.w3.org/TR/WCAG20-TECHS/F65.html)
    * [F66: 成功标准 3.2.3 由于在不同页面上以不同的相对顺序呈现导航链接而失败](https://www.w3.org/TR/WCAG20-TECHS/F66.html)
    * [F67: 成功标准 1.1.1 和 1.2.1 由于提供了不符合相同目的或不提供相同信息的非文本内容的长描述而失败](https://www.w3.org/TR/WCAG20-TECHS/F67.html)
    * [F68: 成功标准 4.1.2 由于用户界面控件没有编程确定的名称而失败](https://www.w3.org/TR/WCAG20-TECHS/F68.html)
    * [F69: 成功标准 1.4.4 当文本大小调整到 200％ 进行视觉渲染时，会导致文本、图像或控件被裁剪、截断或模糊而失败](https://www.w3.org/TR/WCAG20-TECHS/F69.html)
    * [F70: 成功标准 4.1.1 由于不正确使用开始和闭合标签或特性标记而失败](https://www.w3.org/TR/WCAG20-TECHS/F70.html)
    * [F71: 成功标准 1.1.1 由于通过文本外观来表示文本而不提供文本替代品而失败](https://www.w3.org/TR/WCAG20-TECHS/F71.html)
    * [F72: 成功标准 1.1.1 由于使用 ASCII 艺术字而不提供文本替代品而失败](https://www.w3.org/TR/WCAG20-TECHS/F72.html)
    * [F73: 成功标准 1.4.1 由于创建了缺乏色觉的视觉不明显的链接而失败](https://www.w3.org/TR/WCAG20-TECHS/F73.html)
    * [F74: 成功标准 1.2.2 和 1.2.8 由于没有标记同步的媒体替代文本替代品而失败](https://www.w3.org/TR/WCAG20-TECHS/F74.html)
    * [F75: 成功标准 1.2.2 当同步媒体提供了多于页面上呈现的信息，且没有提供字幕而失败](https://www.w3.org/TR/WCAG20-TECHS/F75.html)
    * [F77: 成功标准 4.1.1 由于重复的文档类型 ID 值而失败](https://www.w3.org/TR/WCAG20-TECHS/F77.html)
    * [F78: 成功标准 2.4.7 由于在设置元素的轮廓和边框时删除或渲染不可见的焦点视觉标识而失败](https://www.w3.org/TR/WCAG20-TECHS/F78.html)
    * [F79: 成功标准 4.1.2 由于用户界面组件的焦点状态不能通过程序确定或者没有通知焦点状态改变而失败](https://www.w3.org/TR/WCAG20-TECHS/F79.html)
    * [F80: 成功标准 1.4.4 当基于文本的表单控件在视觉呈现的文本大小调整到 200％ 时没有调整相应的大小而失败](https://www.w3.org/TR/WCAG20-TECHS/F80.html)
    * [F81: 成功标准 1.4.1 由于仅使用色彩差异来标识必填字段或错误字段而失败](https://www.w3.org/TR/WCAG20-TECHS/F81.html)
    * [F82: 成功标准 3.3.2 由于仅对一组电话号码字段进行了视觉格式化但没有包含文本标签而失败](https://www.w3.org/TR/WCAG20-TECHS/F82.html)
    * [F83: 成功标准 1.4.3 和 1.4.6 由于使用的背景图像没有提供与前景文字 (或图像格式的文字) 足够的对比度而失败](https://www.w3.org/TR/WCAG20-TECHS/F83.html)
    * [F84: 成功标准 2.4.9 由于使用如“点击此处”或“更多”等非特指链接，但没有机制将链接文本更改为特定文本而失败](https://www.w3.org/TR/WCAG20-TECHS/F84.html)
    * [F85: 成功标准 2.4.3 由于在导航序列中触发控制与其顺序不相邻的对话框或菜单而失败](https://www.w3.org/TR/WCAG20-TECHS/F85.html)
    * [F86: 成功标准 4.1.2 由于没有为多部分组成的表单字段 (例如美国电话号码) 的每个部分提供名称而失败](https://www.w3.org/TR/WCAG20-TECHS/F86.html)
    * [F87: 成功标准 1.3.1 由于通过 `:before` 和 `:after` 伪元素和 CSS 中的 `content` 属性插入非装饰性内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F87.html)
    * [F88: 成功标准 1.4.8 由于使用对齐 (即左右两侧同时对齐) 的文本而失败](https://www.w3.org/TR/WCAG20-TECHS/F88.html)
    * [F89: 成功标准 2.4.4、2.4.9 和 4.1.2 由于链接唯一的内容是一个图像，但没有为该图像提供可访问的名称而失败](https://www.w3.org/TR/WCAG20-TECHS/F89.html)
    * [F90: 成功标准 1.3.1 用于通过 `headers` 和 `id` 特性错误的关联表格的头和内容而失败](https://www.w3.org/TR/WCAG20-TECHS/F90.html)
    * [F91: 成功标准 1.3.1 无法正确标记表头而失败](https://www.w3.org/TR/WCAG20-TECHS/F91.html)
    * [F92: 成功标准 1.3.1 由于对传达语义信息的内容实用 `role="presentation"` 而失败](https://www.w3.org/TR/WCAG20-TECHS/F92.html)
    * [F93: 成功标准 1.4.2 由于没有办法暂停或停止自动播放 HTML5 媒体元素而失败](https://www.w3.org/TR/WCAG20-TECHS/F93.html)
* Appendix A: [致谢](https://www.w3.org/TR/WCAG20-TECHS/appendixA.html)
* Appendix B: [参考文献](https://www.w3.org/TR/WCAG20-TECHS/appendixB.html)
