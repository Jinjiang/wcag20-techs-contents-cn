...
* 通用技巧 [(单页展示所有通用技巧)](https://www.w3.org/TR/WCAG20-TECHS/general.html)
    ...
    * [G73：在非文本内容附近为其提供一个链接，并在该链接所指的位置为其提供详细的描述 [?]](https://www.w3.org/TR/WCAG20-TECHS/G73.html)
    * [G74：在非文本内容附近为其提供一个长描述，并在其简短描述中提供一个引用到该长描述 [?]](https://www.w3.org/TR/WCAG20-TECHS/G74.html)
