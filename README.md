...
* 常见错误 [(单页展示所有常见错误)](https://www.w3.org/TR/WCAG20-TECHS/failures.html)
    ...
    * [F10: 成功标准 2.1.2 和一致性要求 5，由于结合多种内容格式但使得用户在某种格式中受困而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F10.html)
    ...
    * [F46: 成功标准 1.3.1 由于在表格布局中使用 `th` 元素，`caption` 元素或非空 `summary` 特性而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F46.html)
    ...
    * [F49: 成功标准 1.3.2 由于使用了在线性化时失去意义的 HTML 表格局表而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F49.html)
    ...
    * [F63: 成功标准 2.4.4 由于仅在与链接无关的内容中提供链接上下文而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F63.html)
    ...
    * [F77: 成功标准 4.1.1 由于重复的类型 ID 值而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F77.html)
    * [F78: 成功标准 2.4.7 由于通过删除或渲染不可见的视觉焦点指示器来设置元素的轮廓和边框而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F78.html)
    ...
    * [F82: 成功标准 3.3.2 通过视觉格式化一组电话号码字段但不包括文本标签而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F82.html)
    ...
    * [F86: 成功标准 4.1.2 由于没有为多部分的表单的每个部分提供字段名称，例如美国电话号码，而失败 ?](https://www.w3.org/TR/WCAG20-TECHS/F86.html)
